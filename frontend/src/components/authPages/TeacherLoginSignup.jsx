...
<div class="w-full max-w-5xl p-6 rounded-3xl shadow-xl flex items-center space-x-10 bg-gray-200 ">
  ...
  <div class="login-card bg-white w-1/2 p-10 rounded-lg shadow-lg">
    ...
    <label class="flex items-center mb-4 border border-gray-300 p-2 rounded-lg">
      ...
      <input type="email" placeholder="Teacher Email" class="w-full outline-none text-gray-700" />
    </label>
    <label class="flex items-center mb-6 border border-gray-300 p-2 rounded-lg">
      <svg class="w-5 h-5 text-gray-500 mr-3" fill="currentColor" viewBox="0 0 16 16">
        <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM12.735 14c.618 0 1.093-.561.872-1.139a6.002 6.002 0 0 0-11.215 0c-.22.578.254 1.139.872 1.139h9.47Z" />
      </svg>
      <input type="password" placeholder="Teacher Password" class="w-full outline-none text-gray-700" />
    </label>
    <button class="w-full bg-sky-500 text-white py-3 rounded-lg hover:bg-slate-400 transition duration-300 font-semibold">Login</button>
  </div>
  ...
  <div class="signup-card bg-white w-1/2 p-10 rounded-lg shadow-lg">
    ...
    <label class="flex items-center mb-4 border border-gray-300 p-2 rounded-lg">
      ...
      <input type="text" placeholder="Teacher  Username" class="w-full outline-none text-gray-700" />
    </label>
    <label class="flex items-center mb-6 border border-gray-300 p-2 rounded-lg">
      <svg class="w-5 h-5 text-gray-500 mr-3" fill="currentColor" viewBox="0 0 16 16">
    ...
    <button class="w-full bg-rose-500 text-white py-3 rounded-lg hover:bg-black transition duration-300 font-semibold">Signup</button>
  </div>
</div>
</div>
    </>
