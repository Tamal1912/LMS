    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const videoBase64 = courseDetails.courseContent ? 
                await convertToBase64(courseDetails.courseContent) : null;
            const assignmentBase64 = courseDetails.assignments ? 
                await convertToBase64(courseDetails.assignments) : null;
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Course Outcomes</label>
              <textarea
                value={courseDetails.courseOutcome}
                onChange={(e) => setCourseDetails({...courseDetails, courseOutcome: e.target.value})}
                rows={3}
                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500"
                required
              />
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Course Content (Video)</label>
